    ...
    try {
      ...
      if (response.success) {
        toast({
          ...
          description: "Your farmer account has been created! Please login.",
        });
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4 bg-gray-50">
        <Card className="w-full max-w-xl">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-600 mt-2">Create your account to start selling your produce</p>
          </CardHeader>
          ...
          <CardFooter className="flex justify-center border-t pt-4">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/farmer/login" className="text-agro-primary hover:underline font-medium">
                Login here
              </Link>
            </p>
          </CardFooter>
