      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4">
        <div className="w-full max-w-5xl flex flex-col md:flex-row shadow-2xl rounded-xl overflow-hidden">
          ...
          <div className="md:w-1/2 bg-agro-primary relative hidden md:block">
            <img 
              src="https://images.unsplash.com/photo-1500937386664-56d1dfef3854?ixlib=rb-1.2.1&auto=format&fit=crop&q=80"
              alt="Farmer in field" 
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-agro-dark/60 to-transparent flex flex-col justify-center p-8">
              ...
              <p className="text-white/90 text-lg">
                Access your farmer dashboard to manage your products and connect with customers.
              </p>
            </div>
          </div>
          ...
          <div className="md:w-1/2 bg-white p-6 md:p-10">
            <div className="mb-6 text-center md:text-left">
              <h2 className="text-2xl font-bold text-agro-dark">Farmer Login</h2>
              <p className="text-gray-600 mt-2">Ready to grow your business?</p>
            </div>
            ...
            <div className="mt-6 text-center border-t pt-6">
              ...
              <p className="mt-4 text-gray-600">
                <Link to="/customer/login" className="text-agro-secondary hover:underline">
